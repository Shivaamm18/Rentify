            ...
            {services.map((service) => (
              ...
              >
                <div className="relative mb-3 flex items-center justify-center">
                  ...
                  <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-[#FD3752] opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
                </div>
                
                <span className="text-[14px] font-medium text-[#464646] text-center leading-tight group-hover:text-[#FD3752] transition-colors duration-200 max-w-[100px]">
                  {service.label}
                </span>
              </a>
            ))}
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 border-t border-[#D4D4D4] pt-10">
          {[
            ...
            <div key={idx} className="flex items-center space-x-3 px-4 py-2 border-r last:border-r-0 border-[#D4D4D4]/50">
              <div className="w-2 h-2 rounded-full bg-[#009587] shrink-0" />
              <div>
